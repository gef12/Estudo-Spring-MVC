...
@EnableJpaRepositories(basePackages = "br.com.leosilvadev.pizzaria.modelo.repositorios")
public class ConfiguracaoBD {
	...
	public DataSource dataSource() throws IllegalStateException, PropertyVetoException {
		...
		dataSource.setPassword("12071993");
		return dataSource;
	}
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.leosilvadev.pizzaria.modelo.entidades");
